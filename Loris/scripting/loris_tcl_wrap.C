...
_wrap_exportAiff(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if (SWIG_GetArgs(interp, objc, objv,"spdii:exportAiff path samples samplerate nchannels bitsPerSamp ",&arg1,&arg2,SWIGTYPE_p_SampleVector,&arg3,&arg4,&arg5) == TCL_ERROR) return TCL_ERROR;
    {
        try
        {
