...
static int
_wrap_versionString(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result ;
    
    if (SWIG_GetArgs(interp, objc, objv,":versionString ") == TCL_ERROR) return TCL_ERROR;
    {
        try
        {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "versionString", _wrap_versionString, NULL},
