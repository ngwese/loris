...
AiffFile *new_AiffFile(PartialList *l,double sampleRate,double fadeTime){
...
PartialList *new_PartialList(PartialList const &rhs){
...
_wrap_new_AiffFile__SWIG_2(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if ((SWIG_ConvertPtr(interp, objv[1], (void **) &arg1, SWIGTYPE_p_PartialList,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    {
        try
        {
            result = (AiffFile *)new_AiffFile(arg1,arg2,arg3);
...
_wrap_new_PartialList__SWIG_1(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if ((SWIG_ConvertPtr(interp, objv[1], (void **) &arg1, SWIGTYPE_p_PartialList,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    {
        try
        {
            result = (PartialList *)new_PartialList((PartialList const &)*arg1);
