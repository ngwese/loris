...
static int
_wrap_extract(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    PartialList *arg1 = (PartialList *) 0 ;
    long arg2 ;
    PartialList *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"ol:extract partials label ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(interp, objv[1], (void **) &arg1, SWIGTYPE_p_PartialList,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    {
        *EXCEPTION_THROWN = '\0';
