...
_wrap_PartialList_begin(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    }
    {
        ...
        Tcl_SetObjResult(interp,SWIG_NewPointerObj((void*) resultptr, SWIGTYPE_p_PartialListIterator));
    }
    return TCL_OK;
}
...
_wrap_PartialList_insert(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if ((SWIG_ConvertPtr(interp, objv[2], (void **) &argp2, SWIGTYPE_p_PartialListIterator) != TCL_OK)) return TCL_ERROR;
    arg2 = *argp2; 
    {
        try
        {
...
static void swig_delete_PartialListIterator(void *obj) {
    delete (PartialListIterator *) obj;
}
...
_wrap_Partial_begin(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    }
    {
        ...
        Tcl_SetObjResult(interp,SWIG_NewPointerObj((void*) resultptr, SWIGTYPE_p_PartialIterator));
    }
    return TCL_OK;
}
