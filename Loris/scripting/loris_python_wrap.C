...
static PyObject *_wrap_dilate(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"Oss:dilate",&obj0,&arg2,&arg3)) goto fail;
    if ((SWIG_ConvertPtr(obj0,(void **) &arg1, SWIGTYPE_p_PartialList,SWIG_POINTER_EXCEPTION | 0 )) == -1) SWIG_fail;
    {
        *EXCEPTION_THROWN = '\0';
...
static PyObject *_wrap_extract(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    PartialList *arg1 = (PartialList *) 0 ;
    long arg2 ;
    PartialList *result;
    ...
    if(!PyArg_ParseTuple(args,(char *)"Ol:extract",&obj0,&arg2)) goto fail;
    if ((SWIG_ConvertPtr(obj0,(void **) &arg1, SWIGTYPE_p_PartialList,SWIG_POINTER_EXCEPTION | 0 )) == -1) SWIG_fail;
    {
        *EXCEPTION_THROWN = '\0';
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"extract", _wrap_extract, METH_VARARGS },
