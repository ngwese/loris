 ...
 * Version 1.3u-20010419-2214 (Alpha 5)
 * 
...
static PyObject *_wrap_copyByLabel(PyObject *self, PyObject *args) {
    ...
    if ((SWIG_ConvertPtr(argo2,(void **) &arg2,SWIGTYPE_p_PartialList,1)) == -1) return NULL;
    {
        try
        {
            // LorisErrorString.clear();
            LorisErrorString = "";
            copyByLabel((PartialList const *)arg0,arg1,arg2);
...
void  ExportSpc_write(ExportSpc *self,char const *filename,PartialList const *partials) {
    {
...
static PyObject *_wrap_ExportSpc_write(PyObject *self, PyObject *args) {
    ...
    if ((SWIG_ConvertPtr(argo2,(void **) &arg2,SWIGTYPE_p_PartialList,1)) == -1) return NULL;
    {
        try
        {
            // LorisErrorString.clear();
            LorisErrorString = "";
            ExportSpc_write(arg0,(char const *)arg1,(PartialList const *)arg2);
