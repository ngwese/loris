...
#define  SWIGTYPE_p_vectorTdouble_t swig_types[2] 
...
#define  SWIGTYPE_p_PartialListIterator swig_types[7] 
#define  SWIGTYPE_p_PartialIterator swig_types[8] 
#define  SWIGTYPE_p_Breakpoint swig_types[9] 
#define  SWIGTYPE_p_BreakpointEnvelope swig_types[10] 
