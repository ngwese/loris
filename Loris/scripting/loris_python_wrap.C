 ...
 * Version 1.3u-20010423-1309 (Alpha 5)
 * 
...
static PyObject *_wrap_versionString(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    char *result ;
    
    if(!PyArg_ParseTuple(args,":versionString")) return NULL;
    {
        try
        {
            result = (char *)versionString();
...
static PyMethodDef loriscMethods[] = {
	 ...
	 { "versionString", _wrap_versionString, METH_VARARGS },
