...
class DoubleVector(_object):
    ...
    def empty(*args): return _loris.DoubleVector_empty(*args)
    def size(*args): return _loris.DoubleVector_size(*args)
    def clear(*args): return _loris.DoubleVector_clear(*args)
    def swap(*args): return _loris.DoubleVector_swap(*args)
    def get_allocator(*args): return _loris.DoubleVector_get_allocator(*args)
    def pop_back(*args): return _loris.DoubleVector_pop_back(*args)
    def __init__(self, *args):
        _swig_setattr(self, DoubleVector, 'this', _loris.new_DoubleVector(*args))
        _swig_setattr(self, DoubleVector, 'thisown', 1)
    def push_back(*args): return _loris.DoubleVector_push_back(*args)
    def front(*args): return _loris.DoubleVector_front(*args)
    def back(*args): return _loris.DoubleVector_back(*args)
    def assign(*args): return _loris.DoubleVector_assign(*args)
    def resize(*args): return _loris.DoubleVector_resize(*args)
    def reserve(*args): return _loris.DoubleVector_reserve(*args)
    def capacity(*args): return _loris.DoubleVector_capacity(*args)
...
class MarkerVector(_object):
    ...
    def empty(*args): return _loris.MarkerVector_empty(*args)
    def size(*args): return _loris.MarkerVector_size(*args)
    def clear(*args): return _loris.MarkerVector_clear(*args)
    def swap(*args): return _loris.MarkerVector_swap(*args)
    def get_allocator(*args): return _loris.MarkerVector_get_allocator(*args)
    def pop_back(*args): return _loris.MarkerVector_pop_back(*args)
    def __init__(self, *args):
        _swig_setattr(self, MarkerVector, 'this', _loris.new_MarkerVector(*args))
        _swig_setattr(self, MarkerVector, 'thisown', 1)
    def push_back(*args): return _loris.MarkerVector_push_back(*args)
    def front(*args): return _loris.MarkerVector_front(*args)
    def back(*args): return _loris.MarkerVector_back(*args)
    def assign(*args): return _loris.MarkerVector_assign(*args)
    def resize(*args): return _loris.MarkerVector_resize(*args)
    def reserve(*args): return _loris.MarkerVector_reserve(*args)
    def capacity(*args): return _loris.MarkerVector_capacity(*args)
