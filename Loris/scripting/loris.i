...
%title "Loris procedural interface"
%module loris %{
...
void dilate_str( PartialList_Ptr partials, 
...
SampleVector_Ptr createSampleVector( unsigned long size = 0 );
...
/*
 */
%section "Non-object-based procedures"
%text %{
...
%name(dilate) void dilate_str( PartialList_Ptr partials, 
...
void exportSdif( const char * path, PartialList_Ptr partials, double hop = 0. );
