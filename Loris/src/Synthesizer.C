...
//  See default constructor, defined below, for the initial values
//  assigned to these defaults.
...
// ---------------------------------------------------------------------------
//  Synthesizer::Parameters validate
// ---------------------------------------------------------------------------
//! Check that the synthesis parameters stored in this stuct are
//! valid. Return true if the set of parameters is valid, and false
//! otherwise.
void
Synthesizer::Parameters::validate( void ) const
{
    //  check to make sure that the sample rate is valid:
    if ( 0. >= sampleRate ) 
    {
