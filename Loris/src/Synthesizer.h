...
//	-- parameters structure --
	...
	struct Parameters
	{
		...
		//  TODO:
		//  add a member for validating params, and use it!
		//  implement the constructors that accept Parameters args
		//  implement the enhancement flag in Synthesizer
		
		
		//  validate
		//
		//! Check that the synthesis parameters stored in this stuct are
		//! valid. Raise InvalidArgument if any of the parameters is 
	...
	static Parameters & DefaultParameters( void );
