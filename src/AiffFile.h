...
public:
  ...
  AiffFile(Iter begin_partials, Iter end_partials, double samplerate,
           double fadeTime = FadeTimeUnspecified);
#else
  AiffFile(PartialList::const_iterator begin_partials,
           PartialList::const_iterator end_partials, double samplerate,
           double fadeTime = FadeTimeUnspecified);
#endif
...
#if !defined(NO_TEMPLATE_MEMBERS)
template <typename Iter>
AiffFile::AiffFile(Iter begin_partials, Iter end_partials, double samplerate,
                   double fadeTime)
    :
#else
inline AiffFile::AiffFile(PartialList::const_iterator begin_partials,
                          PartialList::const_iterator end_partials,
...
#if !defined(NO_TEMPLATE_MEMBERS)
template <typename Iter>
void AiffFile::addPartials(Iter begin_partials, Iter end_partials,
                           double fadeTime)
#else
inline void AiffFile::addPartials(PartialList::const_iterator begin_partials,
                                  PartialList::const_iterator end_partials,
                                  double fadeTime)
#endif
{
