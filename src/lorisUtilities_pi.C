 ...
 */
extern "C" double avgAmplitude(const Partial *p) {
  try {
...
/*  Return the average frequency over all Breakpoints in this Partial.
    Return zero if the Partial has no Breakpoints.
 */
extern "C" double avgFrequency(const Partial *p) {
  try {
    ThrowIfNull((Partial *)p);
 ...
 */
extern "C" void copyIf(const PartialList *src, PartialList *dst,
...
/*	Append copies of Partials in the source PartialList having the
        ...
        is unmodified.
 */
extern "C" void copyLabeled(const PartialList *src, long label,
                            PartialList *dst) {
  try {
    ThrowIfNull((PartialList *)src);
    ThrowIfNull((PartialList *)dst);
 ...
 */
extern "C" void crop(PartialList *partials, double t1, double t2) {
  try {
...
/*	Remove Partials in the source PartialList satisfying the
    ...
    additional data is needed.
 */
extern "C" void extractIf(PartialList *src, PartialList *dst,
                          int (*predicate)(const Partial *p, void *data),
                          void *data) {
  try {
    ThrowIfNull((PartialList *)src);
...
predicate, data ) ); it != src->end(); it = std::find_if( it, src->end(),
...
/*	Remove Partials in the source PartialList having the specified
    ...
    PartialList.
 */
extern "C" void extractLabeled(PartialList *src, long label, PartialList *dst) {
  try {
    ThrowIfNull((PartialList *)src);
    ThrowIfNull((PartialList *)dst);
...
PartialUtils::isLabelEqual(label) ); it != src->end(); it = std::find_if( it,
src->end(), PartialUtils::isLabelEqual(label) ) )
{
    //  the iterator passed to splice is a copy of it
    //  before the increment, so it is not corrupted
    //  by the splice, it is advanced to the next
...
/*  Recompute phases of all Breakpoints later than the specified
    ...
    from that one.
 */
extern "C" void fixPhaseAfter(PartialList *partials, double time) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void fixPhaseAt(PartialList *partials, double time) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void fixPhaseBefore(PartialList *partials, double time) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void fixPhaseBetween(PartialList *partials, double tbeg,
                                double tend) {
  try {
    ThrowIfNull((PartialList *)partials);
...
/*  Recompute phases of all Breakpoints later than the specified
    ...
    from that one.
 */
extern "C" void fixPhaseForward(PartialList *partials, double tbeg,
                                double tend) {
  try {
    ThrowIfNull((PartialList *)partials);
...
/*	Apply a function to each Breakpoint in a Partial. The function
        ...
        user-defined data to the function. Pass 0 if no additional data is
needed. The function should return 0 if successful. If the function returns a
non-zero value, then forEachBreakpoint immediately returns that value without
applying the function to any other Breakpoints in the Partial. forEachBreakpoint
returns zero if all calls to func return zero.
 */
 ...
 */
int forEachPartial(PartialList *src, int (*func)(Partial *p, void *data),
                   void *data) {
  int result = 0;
  try {
    ThrowIfNull((PartialList *)src);
 ...
 */
extern "C" double peakAmplitude(const Partial *p) {
  try {
    ThrowIfNull((Partial *)p);
...
/*	Remove from a PartialList all Partials satisfying the
    ...
    additional data is needed.
 */
extern "C" void removeIf(PartialList *src,
                         int (*predicate)(const Partial *p, void *data),
                         void *data) {
  try {
    ThrowIfNull((PartialList *)src);
 ...
 */
extern "C" void removeLabeled(PartialList *src, long label) {
  try {
    ThrowIfNull((PartialList *)src);
    std::list<Partial>::iterator it = std::remove_if(
 ...
 */
extern "C" void scaleAmp(PartialList *partials, BreakpointEnvelope *ampEnv) {
 ...
 */
extern "C" void scaleAmplitude(PartialList *partials,
                               BreakpointEnvelope *ampEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void scaleBandwidth(PartialList *partials,
                               BreakpointEnvelope *bwEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
...
/*	Assign the bandwidth of the Partials in a PartialList according
        to an envelope representing a time-varying bandwidth scale value.
 */
extern "C" void setBandwidth(PartialList *partials, BreakpointEnvelope *bwEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
    ThrowIfNull((BreakpointEnvelope *)bwEnv);
 ...
 */
extern "C" void scaleFrequency(PartialList *partials,
                               BreakpointEnvelope *freqEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
...
/*	Scale the relative noise content of the Partials in a PartialList
        ...
        scale value.
 */
extern "C" void scaleNoiseRatio(PartialList *partials,
                                BreakpointEnvelope *noiseEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void shiftPitch(PartialList *partials,
                           BreakpointEnvelope *pitchEnv) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void shiftTime(PartialList *partials, double offset) {
  try {
    ThrowIfNull((PartialList *)partials);
 ...
 * 	reordered.
 */
extern "C" void sortByLabel(PartialList *partials) {
 ...
 *  and tmax.
 */
extern "C" void timeSpan(PartialList *partials, double *tmin, double *tmax) {
...
/*  Return the average frequency over all Breakpoints in this Partial,
    ...
    has no Breakpoints.
 */
extern "C" double weightedAvgFrequency(const Partial *p) {
  try {
    ThrowIfNull((Partial *)p);
