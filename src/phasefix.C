...
//	Return the total unwrapped phase travel.
//
static double phaseTravel(Partial::const_iterator bp0,
                          Partial::const_iterator bp1) {
...
//! \param		damping The fraction of the amount of phase error that
//! will
//!				be corrected (.5 or less will prevent frequency
//! oscilation 				due to burst errors in phase).
//! \param		maxFixPct The maximum amount of frequency adjustment
//!				that can be made to the frequency of bp1,
//! expressed 				as a precentage of the unmodified frequency of
//! bp1. 				If the necessary amount of frequency
//! adjustment exceeds 				this amount, then the phase will
//! not be matched, 				but will be updated as well to be consistent
//! with 				the frequencies. (default is 0.2%)
//
void matchPhaseFwd(Breakpoint &bp0, Breakpoint &bp1, double dt, double damping,
                   double maxFixPct) {
