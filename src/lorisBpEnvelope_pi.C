 ...
 */
extern "C" LinearEnvelope *createLinearEnvelope(void) {
  try {
 ...
 */
extern "C" LinearEnvelope *copyLinearEnvelope(const LinearEnvelope *ptr_this) {
  try {
 ...
 */
extern "C" void destroyLinearEnvelope(LinearEnvelope *ptr_this) {
  try {
...
/*	Insert a breakpoint representing the specified (time, value)
        ...
        the new breakpoint.
 */
extern "C" void linearEnvelope_insertBreakpoint(LinearEnvelope *ptr_this,
...
/*	Return the interpolated value of this LinearEnvelope at the
        specified time.
 */
extern "C" double linearEnvelope_valueAt(const LinearEnvelope *ptr_this,
                                         double time) {
  try {
    ThrowIfNull((LinearEnvelope *)ptr_this);
