...
#else
  inline PartialList::iterator collate(PartialList &partials);
#endif
...
#else
  static inline PartialList::iterator collate(PartialList &partials,
                                              double partialFadeTime,
                                              double partialSilentTime);
#endif
...
#else
inline PartialList::iterator Collator::collate(PartialList &partials)
#endif
{
#if !defined(NO_TEMPLATE_MEMBERS)
...
#else
inline PartialList::iterator Collator::operator()(PartialList &partials)
#endif
{
