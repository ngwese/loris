 ...
 */
extern "C" PartialList *createPartialList(void) {
  try {
 ...
 */
extern "C" void destroyPartialList(PartialList *ptr_this) {
  try {
...
/*	Remove (and destroy) all the Partials from this PartialList,
        leaving it empty.
 */
extern "C" void partialList_clear(PartialList *ptr_this) {
  try {
    ThrowIfNull((PartialList *)ptr_this);
    ptr_this->clear();
  } catch (Exception &ex) {
...
/*	Make this PartialList a copy of the source PartialList by making
        ...
        this PartialList.
 */
extern "C" void partialList_copy(PartialList *dst, const PartialList *src) {
  try {
 ...
 */
extern "C" unsigned long partialList_size(const PartialList *ptr_this) {
  try {
    ThrowIfNull((PartialList *)ptr_this);
 ...
 */
extern "C" void partialList_splice(PartialList *dst, PartialList *src) {
  try {
    ThrowIfNull((PartialList *)dst);
    ThrowIfNull((PartialList *)src);
...
/*	Return the (absolute) amplitude of the specified Partial interpolated
        ...
        It is an error to apply this function to a Partial having no
Breakpoints.
 */
