...
public:
  ...
  LinearEnvelope &operator-=(double offset) { return operator+=(-offset); }
  ...
  //!         the envelope
  LinearEnvelope &operator/=(double div) { return operator*=(1.0 / div); }
...
//! LinearEnvelope.
inline LinearEnvelope operator+(LinearEnvelope env, double offset) {
  env += offset;
  return env;
}
...
//! Add a constant value to a LinearEnvelope and return a new
//! LinearEnvelope.
inline LinearEnvelope operator+(double offset, LinearEnvelope env) {
  env += offset;
  return env;
}

//! Add two LinearEnvelopes and return a new LinearEnvelope.
inline LinearEnvelope operator+(const LinearEnvelope &e1,
                                const LinearEnvelope &e2) {
  LinearEnvelope ret;
...
//! LinearEnvelope.
inline LinearEnvelope operator*(LinearEnvelope env, double scale) {
  env *= scale;
  return env;
}
...
//! Scale a LinearEnvelope by a constant value and return a new
//! LinearEnvelope.
inline LinearEnvelope operator*(double scale, LinearEnvelope env) {
  env *= scale;
  return env;
}
...
//! LinearEnvelope.
inline LinearEnvelope operator/(LinearEnvelope env, double div) {
  env /= div;
  return env;
}
