...
inline ScaleAndOffsetEnvelope operator*(const Envelope &e, double x) {
  return ScaleAndOffsetEnvelope(e, x, 0);
}

inline ScaleAndOffsetEnvelope operator*(double x, const Envelope &e) {
  return e * x;
}
