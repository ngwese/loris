...
#else
  inline void sift(PartialList::iterator sift_begin,
...
#else
  inline void sift(PartialList &partials)
#endif
  {
...
#else
  static inline void sift(PartialList::iterator sift_begin,
                          PartialList::iterator sift_end,
...
#else
inline void Sieve::sift(PartialList::iterator sift_begin,
                        PartialList::iterator sift_end)
#endif
{
  PartialPtrs ptrs;
...
#if !defined(NO_TEMPLATE_MEMBERS)
template <typename Iter>
void Sieve::sift(Iter sift_begin, Iter sift_end, double partialFadeTime)
#else
inline void Sieve::sift(PartialList::iterator sift_begin,
                        PartialList::iterator sift_end, double partialFadeTime)
#endif
{
