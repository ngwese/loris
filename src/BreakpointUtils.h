...
//!			should succeed bp
//! \return	a new null Breakpoint, having zero amplitude, frequency equal
//!			to that of bp, and phase computed forward from that of
//! bp
//
...
//
static bool isNonNull(const Breakpoint &bp) { return bp.amplitude() != 0.; }
...
//! amplitude, false otherwise.
//
static bool isNull(const Breakpoint &bp) { return !isNonNull(bp); }
