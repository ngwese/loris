...
public:
  ...
  enum {
    Default_ResidueBandwidth_RegionWidth = 2000,
  ...
  void storeConvergenceBandwidth(
      double tolerancePct = 0.01 *
                            (double)Default_ConvergenceBandwidth_TolerancePct);
  ...
  enum {
    Default_FundamentalEnv_ThreshDb = -60,
  ...
  //!         low amplitude peaks tend to have less reliable frequency
...
private:
  ...
  double
      m_bwAssocParam; //!  formerly, width in Hz of overlapping bandwidth
                      ...
                      //!  (%) level used to construct bandwidth envelopes from
                      //!  the mixed phase derivative indicator
