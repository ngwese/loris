...
//
static std::istream &readSamples(std::istream &s, std::vector<Byte> &bytes) {
...
//	Let exceptions propogate.
//
static std::ostream &writeSamples(std::ostream &s,
...
#define FloatToUnsigned(f)                                                     \
  ((Int_32)((Int_32(f - 2147483648.0)) + (Int_32)(2147483647)) + 1)
...
#define UnsignedToFloat(u)                                                     \
  (((double)((Int_32)(u - (Int_32)(2147483647) - 1))) + 2147483648.0)

/****************************************************************
 * Extended precision IEEE floating-point conversion routine.
 ****************************************************************/

double ConvertFromIeeeExtended(const extended80 *x) { /* LCN */ /* ? */
  double f;
  int expon;
  Int_32 hiMant, loMant;
  ...
  hiMant = ((int)(bytes[2] & 0xFF) << 24) | ((int)(bytes[3] & 0xFF) << 16) |
           ((int)(bytes[4] & 0xFF) << 8) | ((int)(bytes[5] & 0xFF));
  loMant = ((int)(bytes[6] & 0xFF) << 24) | ((int)(bytes[7] & 0xFF) << 16) |
