...
//!
//!	The Synthesizer does not own the sample buffer, the client is
//! responsible 	for its construction and destruction, and many Synthesizers
//! may share 	a buffer.
//
class Synthesizer {
  //	-- public interface --
public:
  ...
  //! non-negative). 	\throw	InvalidArgument if the specfied sample rate is
  //! non-positive. 	\throw	InvalidArgument if the specified fade time is
  //! negative.
...
#else
  inline void synthesize(PartialList::const_iterator begin_partials,
...
#else
  inline void operator()(PartialList::const_iterator begin_partials,
                         PartialList::const_iterator end_partials);
#endif
...
#if !defined(NO_TEMPLATE_MEMBERS)
template <typename Iter>
void Synthesizer::synthesize(Iter begin_partials, Iter end_partials)
#else
inline void Synthesizer::synthesize(PartialList::const_iterator begin_partials,
                                    PartialList::const_iterator end_partials)
#endif
{
...
#if !defined(NO_TEMPLATE_MEMBERS)
template <typename Iter>
void Synthesizer::operator()(Iter begin_partials, Iter end_partials)
#else
inline void Synthesizer::operator()(PartialList::const_iterator begin_partials,
                                    PartialList::const_iterator end_partials)
#endif
{
  synthesize(begin_partials, end_partials);
