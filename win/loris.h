...
#define LORIS_MINOR_VERSION 5
#define LORIS_SUBMINOR_VERSION 3
#define LORIS_VERSION_STR "Loris 1.5.3"
...
/*  Deprecated, use analyzer_setStoreResidueBandwidth instead.
 */
